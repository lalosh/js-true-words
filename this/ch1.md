<div dir="rtl">
<link ref="stylesheet" href="https://www.alhamdlilah.com/quran/fonts.css">


<div style="font-family; conv_original-hafs">
...
يقوم التابع باستدعاء نفسه عدد من المرات لإنهاء مهمة ما مثل تابع حساب العاملي لرقم معين n! 
3! = 3 * 2 * 1
...
ولكن في JS نجد أن `this` لا تشير الى ذات التابع وانما تشير لغرض ما, وفي حال أردت استدعاء التابع من داخله لأسباب عودية عليك استخدام اسم التابع ببساطة… راجع معي آخر جملة مجدداً: `this` لا تشير إلى التابع وإنّما إلى غرض ما, هنا يأتي الأمر الثاني فربما أردت الإشارة إلى التابع نفسه لا من أجل استدعائه عوديا بل من منطلق ان كل التوابع في JS هي في النهاية أغراض وبالتالي ريما اردت تخزين بعض القيم ضمن التابع نفسه
...
لماذا؟ ألم أقم باستدعاء التابع أربع مرات؟ لماذا اذا ما زالت قيمة `clickHandler.count` لم تتغير؟ لأن `this` لا تشير الى ذات 
...
كيف وصلنا الى هذا الاستنتاج؟ طالما أن `this` يتم تحديدها عند التنفيذ وتعريفنا للتابع نفسه لا يتغير ضمن التنفيذ و `this` تعطي نتائج مختلفة حسب طريقة او مكان التنفيذ اذا فأول شيء انظر اليه هو مكان وطريقة استدعاء التابع لا تعريف التابع بحد ذاته
...
الخلاصة: `this` كلمة معرّفة ضمن كل تابع يتم تحديد ما تشير إليه في لحظة استدعاء التابع فهذا التحديد يعتمد كليا على مكان استدعاء التابع ولا علاقة له بمكان تعريف التابع ذاته, فالبحث عن مكان استدعاء التابع هو أول ما سنناقشه في الفصل القادم ان شاء الله.
